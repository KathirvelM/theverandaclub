...
public class FavouriteAdapter extends MyAdapter<MyAdapter.ItemViewHolder> implements Type{

    public interface Listener extends MyAdapter.Listener{
        void  onClickItem(String articleId, String typeId, Container container);
    }

    List<Container> containerList;
    Listener listener;

    public FavouriteAdapter(List<Container> containerList, Listener listener) {
        super(listener);
    ...
    //    Article article;
        ...
        public void onClick(View view) {
            FavouriteAdapter.this.listener.onClickItem(articleData.getId(),String.valueOf(container.getType()),container);
        }
    }
    ...
    class RvHolder extends ItemViewHolder {
        ...
        class ItemAdapter extends MyAdapter<ItemViewHolder>{
            ...
            class SliderHolder extends  ItemViewHolder implements View.OnClickListener {
                ...
                @Override
                public void onClick(View view) {
                    FavouriteAdapter.this.listener.onClickItem("","", container);
                }
            }
